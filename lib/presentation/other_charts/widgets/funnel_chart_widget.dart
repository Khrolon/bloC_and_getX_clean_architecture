...
class FunnelOtherChartWidget extends StatefulWidget {
  const FunnelOtherChartWidget({Key? key}) : super(key: key);

  @override
  State<FunnelOtherChartWidget> createState() => _FunnelOtherChartWidgetState();
}

class _FunnelOtherChartWidgetState extends State<FunnelOtherChartWidget> {
